...
class ComputerState extends MusicBeatState {
    ...
    var curSubFolder:Array<Dynamic>; // current opened subfolder
    ...
    var maigoDialogues:Array<Dynamic> = [];
