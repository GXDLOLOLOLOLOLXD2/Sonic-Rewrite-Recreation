		...
		new FlxTimer().start(0.75, (_) -> {
			switch (state) {
                case "options/GraphicSettings":
                    MusicBeatState.switchState(new GraphicsSettingsSubState());
                case "options/VisualSettings":
                    MusicBeatState.switchState(new VisualsUISubState());
                case "options/GameplaySettings":
                    MusicBeatState.switchState(new GameplaySettingsSubState());
